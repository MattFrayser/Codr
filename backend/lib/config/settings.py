...
class AppSettings(BaseSettings):
    ...
    job_queue_name: str = Field(default="codr:job_queue", description="Redis job queue name")
    worker_poll_timeout: int = Field(default=5, description="Worker queue poll timeout in seconds")
    worker_id: Optional[str] = Field(default=None, description="Worker identifier (auto-generated if not set)")
