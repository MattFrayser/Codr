...
from api.connect.redis_manager import get_async_redis, AsyncRedisManager
...
async def test_input_pubsub():
    ...
    async def subscriber():
        # Create a NEW pubsub instance (not reusing connection)
        ps = redis.pubsub()
...
async def run_all_tests():
    """Run all tests in same event loop"""
    print("=" * 60)
    ...
    try:
        ...
        from api.connect.redis_manager import AsyncRedisManager
